                ...
                <article className="-mt-4 prose prose-invert prose-p:text-muted prose-p:leading-relaxed prose-headings:text-foreground prose-headings:font-semibold prose-a:text-foreground hover:prose-a:text-muted prose-blockquote:border-l-foreground/30 prose-blockquote:text-muted/80 w-full max-w-none">
                        <ReactMarkdown
                            ...
                            components={{
                                ...
                                h2: ({ ...props }: any) => <h2 className="text-2xl mt-8 mb-4 text-foreground font-semibold" {...props} />,
                                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                                h3: ({ ...props }: any) => <h3 className="text-xl mt-6 mb-3 text-foreground font-semibold" {...props} />,
                                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                                p: ({ ...props }: any) => <div className="my-4 text-muted leading-relaxed" {...props} />,
                                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                                ol: ({ ...props }: any) => <ol className="list-decimal pl-5 space-y-2 my-4 text-muted" {...props} />,
                                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                                ul: ({ ...props }: any) => <ul className="list-disc pl-5 space-y-2 my-4 text-muted" {...props} />,
                                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                                li: ({ ...props }: any) => <li className="text-muted leading-relaxed" {...props} />,
                                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                                pre: (props: any) => {
                                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
                                ...
                                blockquote: ({ ...props }) => <blockquote className="border-l-4 border-foreground/30 pl-4 py-1 my-6 text-foreground/80 italic font-medium" {...props} />,
