        ...
        <div className="mt-12 pt-8 border-t border-border">
            ...
            {status === 'loading' ? (
                ...
                <motion.div
                    ...
                    className="p-6 bg-gray-50 dark:bg-gray-900 rounded-xl border border-border text-center"
                >
                    <p className="text-sm text-muted mb-4">Sign in with GitHub to leave a comment</p>
                    <button
                        onClick={() => signIn('github')}
                        className="inline-flex items-center gap-2 px-4 py-2 bg-foreground text-background 
